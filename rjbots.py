...
acil = PRANKBOTS.LINE() 
acil.login(token="EwLS2rEblBFyjzxLif11.5rKA9NFxWmauR0iu1tyF0q.eq/fjEStIQZLaLPOdLxlJ9cCZb1bdB2n1UHcb2ZZdQo=")
acil.loginResult()

pb1 = PRANKBOTS.LINE() 
pb1.login(token="EwcjgY5HhjnEiRQJqmd8.OIewuwRQVBTbsN5ofOjvoa.Kfa8LLYNPbG71vA+KZ0+6KKgXfGga9MdJbxO2MjHdpM=")
pb1.loginResult()

pb2 = PRANKBOTS.LINE() 
pb2.login(token="EwOksM1Jj4Z6g4SQcnHb.O9VUYf4al6/Ij4CD0zdy/W.oVnCjvlw9Tl17JHudkXWMp2oMmsDfcMU3KTKQ857Gsc=")
pb2.loginResult()
...
helpMessage ="""(╣•『❂°RJ`Bõtš°❂ 』•╣)
╔══RÂJÄ༘༘༘༘༘̈́̈́̈́̈́̈́̈́̈́̈́̈́̈́   ̈́Ö༘́̈́F༘̈́̈́ ̈́  BÕT§༘̈́̈́══╗
║Me
║Add
║Cn "text"
║Clockname "text"
...
admsa = "ub3adc8bc91e3dca85b0002a2ff87cb04"
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"""❂••••AUTO ADD BY CHANNEL 『❂°RJ`Bõtš°❂ 』••••❂\n❂•••JANGAN LUPA DI ADD YA••••❂""",
    "lang":"JP",
    "comment1":"❂••••AUTO ADD BY CHANNEL 『❂°RJ`Bõtš°❂ 』••••❂\n❂•••JANGAN LUPA DI ADD YA••••❂",
    ...
    try:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'ub3adc8bc91e3dca85b0002a2ff87cb04'}
                acil.sendMessage(msg)
...
#--------------------------------------------------------
                ...
                msg.contentMetadata = {'mid': 'ub3adc8bc91e3dca85b0002a2ff87cb04'}
                acil.sendMessage(msg)
                acil.sendText(msg.to,"❂•••••{CREATOR 『❂°RJ`Bõtš°❂ 』}•••••❂")
                ...
                for i in gid:
                    ...
                    ki6.leaveGroup(i)
                if wait["lang"] == "JP":
                    acil.sendText(msg.to,"『❂°RJ`Bõtš°❂ 』 Sudah Keluar Di semua grup")
                else:
